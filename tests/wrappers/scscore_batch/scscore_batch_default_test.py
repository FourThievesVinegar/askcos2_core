...
class SCScoreBatchTest(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.v2_url = f"http://{V2_HOST}:{V2_PORT}/api/scscore/batch"
    ...
    def test_1(self):
        case_file = "tests/wrappers/scscore_batch/default_test_case_1.json"
        ...
        self.assertEqual(response_sync["result"], response_async["result"])
